...
const STATUSVIESTIT = {
    ...
    EI_LOYTYNYT: numero => ({
        viesti:`Annetulla numero:llä ${numero} ei löytynyt tietoja`,
        statuskoodi:STATUSKOODIT.EI_LOYTYNYT,
        tyyppi:'virhe'
    }),
    LISAYS_OK: numero=> ({
        viesti:`Tieto numero:llä ${numero} lisättiin`,
    ...
    JO_KAYTOSSA: numero =>({
        viesti:`Id ${numero} oli jo käytössä`,
        statuskoodi:STATUSKOODIT.JO_KAYTOSSA,
        tyyppi:'virhe'
    }),
    POISTO_OK: numero =>({
        viesti:`Tieto numero:llä ${numero} poistettiin`,
        statuskoodi:STATUSKOODIT.POISTO_OK,
        tyyppi:'info'
    }),
    EI_POISTETTU: ()=>({
        viesti:'Annetulla numero:llä ei löytynyt tietoja. Mitään ei poistettu',
        statuskoodi:STATUSKOODIT.EI_POISTETTU,
        tyyppi:'virhe'
    }),
    PAIVITYS_OK: numero =>({
        viesti:`Tiedot numero:llä ${numero} päivitettiin`,
